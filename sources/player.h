...
public:
	...
	{
		if (client)
			client->sendCreatureSay(creature, type, text, pos, statementId);
	}
	...
	{
		if (client)
			client->sendCreatureChannelSay(creature, type, text, channelId, statementId);
	}
