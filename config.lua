...
maxPlayers = 1000
motd = "Welcome to the Nto Star Ninja!"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = false
allowClones = false
serverName = "NTO STAR NINJA"
loginMessage = "Welcome to the NTO SN World!"
...
mapName = "Map.otbm"
mapAuthor = "ADM NTO SN"
randomizeTiles = true
storeTrash = true
cleanProtectedZones = true
mailboxDisabledTowns = ""

mailMaxAttempts = 99999
mailBlockPeriod = 10
mailAttemptsFadeTime = 10
