local potions = {
	-- ultimate potion
	[16112] = { heal = { health = 9000, mana = 9000, randomizer = 1000 }, effect = 502 },

	-- reiatsu potion
	[16113] = { heal = { mana = 9000, randomizer = 1000 }, effect = 502 },

	-- health potion
	[16114] = { heal = { health = 9000, randomizer = 1000 }, effect = 502 },

	-- reiatsu pill
	[16116] = { heal = { mana = 4500, randomizer = 500 }, effect = 502 },

	-- health pill
	[16117] = { heal = { health = 4500, randomizer = 500 }, effect = 502 },
