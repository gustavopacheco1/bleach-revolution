...
if (NpcHandler == nil) then
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_BUY]            = 'Do you want to buy |ITEMCOUNT| |ITEMNAME| for |TOTALCOST| ryo?',
			[MESSAGE_ONBUY]          = 'It was a pleasure doing business with you.',
			[MESSAGE_BOUGHT]         = 'Bought |ITEMCOUNT|x |ITEMNAME| for |TOTALCOST| ryo.',
			[MESSAGE_SELL]           = 'Do you want to sell |ITEMCOUNT| |ITEMNAME| for |TOTALCOST| ryo?',
		...
		messages_pt = {
			...
			[MESSAGE_BUY]            = 'Você deseja comprar |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| ryo?',
			[MESSAGE_ONBUY]          = 'Foi um prazer fazer negócios com você.',
			[MESSAGE_BOUGHT]         = 'Comprou |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ryo.',
			[MESSAGE_SELL]           = 'Você deseja vender |ITEMCOUNT| |ITEMNAME| por |TOTALCOST| ryo?',
