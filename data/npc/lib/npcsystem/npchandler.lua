...
if (NpcHandler == nil) then
	...
	NpcHandler = {
		...
		messages = {
			...
			[MESSAGE_BOUGHT]         = 'Bought |ITEMCOUNT|x |ITEMNAME| for |TOTALCOST| ryos.',
			...
			[MESSAGE_SOLD]           = 'Sold |ITEMCOUNT|x |ITEMNAME| for |TOTALCOST| ryos.',
		...
		messages_pt = {
			...
			[MESSAGE_BOUGHT]         = 'Comprou |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ryos.',
			...
			[MESSAGE_SOLD]           = 'Vendeu |ITEMCOUNT|x |ITEMNAME| por |TOTALCOST| ryos.',
