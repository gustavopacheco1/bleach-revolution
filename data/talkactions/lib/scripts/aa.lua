...
if not(getPlayerVocation(cid) >= 0 and getPlayerVocation(cid) <= 0) and getPlayerStorageValue(cid, 89745) < 6 then
doPlayerSendCancel(cid, "Voce prescisa ter a classe akatsuki para usar esta magia!")
return FALSE
end
