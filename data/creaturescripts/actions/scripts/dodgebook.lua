local config = {
   effectonuse = 125, -- efeito que sai
...
doPlayerSendTextMessage(cid,22,"You've Leveled your Kawarami Skill to ["..(getPlayerStorageValue(cid, config.storagedodge)+1).."/100].")
...
doPlayerSendTextMessage(cid,22,"You've already reached the MAX level of Kawarami Skill.\nCongratulations!!!!")
    return 0
    end
return 1
end