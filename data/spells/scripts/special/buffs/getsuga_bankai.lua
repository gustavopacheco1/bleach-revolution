...
-- Skills --
ml = 5, -- quantos ira aumentar o skill de ML
skillfist = 5, -- quantos ira aumentar o skill de Fist
skillsword = 5, -- quantos ira aumentar o skill de Sword
...
skillshield = 5, -- quantos ira aumentar o skill de Shield
-- //Skills --
outfit = 6, --- outfit que o player ira ter
storage = 15674, -- storage que salva o cooldown
cooldown = 80, -- tempo em segundos de 1 uso e outro
efeito = 669 -- efeito que sai ao castar a spell
}
